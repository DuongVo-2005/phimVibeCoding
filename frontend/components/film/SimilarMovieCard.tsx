...
export function SimilarMovieCard({
  ...
  return (
    <Link
      href={href}
      className="group relative aspect-[2/3] rounded-[20px] overflow-hidden border border-white/5 block"
    >
      <Image
        src={imageSrc}
        alt={title}
      ...
      <div className="hidden md:flex absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex-col justify-end p-md">
